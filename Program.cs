...
partial class Program
{
    ...
    private static void PrintUsage()
    {
        ...
        Console.WriteLine("  LVFVF convert-strokes <input-video> [output.lvfs] [--quality 82] [--stroke-density 78] [--surface-detail 65] [--surface-opacity 10] [--residual 6] [--glow 38] [--vector-only] [--keyframe 30] [--pipeline 4] [--max-frames 0] [--accel auto|cpu|cuda|opencl|hybrid|ffmpeg] [--compression optimal|fast|smallest] [--profile]");
