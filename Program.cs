...
partial class Program
{
    ...
    private static void PrintUsage()
    {
        ...
        Console.WriteLine("  LVFVF convert-strokes <input-video> [output.lvfs] [--quality 82] [--stroke-density 60] [--surface-detail 35] [--residual 20] [--glow 55] [--keyframe 30] [--pipeline 4] [--max-frames 0] [--accel auto|cpu|cuda|opencl|hybrid|ffmpeg] [--compression optimal|fast|smallest] [--profile]");
